...
void InitGame()
{
	player.zicc = LoadTexture("resources/zicc.png"); //change this to the file path in windows explorer if the texture is not loading. use forwardslash not backslash
